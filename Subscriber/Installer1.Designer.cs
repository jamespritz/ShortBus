...
namespace Subscriber {
    partial class Installer1 {
        ...
        private void InitializeComponent() {
            ...
            //ServiceInstaller1 
            // 
            this.BeforeInstall += new System.Configuration.Install.InstallEventHandler(ServiceInstaller1_BeforeInstall);
            this.BeforeUninstall += new System.Configuration.Install.InstallEventHandler(ARIFeedServiceInstaller_BeforeUninstall);
        ...
        void ARIFeedServiceInstaller_BeforeUninstall(object sender, System.Configuration.Install.InstallEventArgs e) {
        ...
        void ServiceInstaller1_BeforeInstall(object sender, System.Configuration.Install.InstallEventArgs e) {
            System.Console.WriteLine("*************************************************************");
